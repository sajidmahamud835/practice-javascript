...
// console.log(seerToMon(-40)); // output should be invalid message
// console.log(seerToMon(40.50)); //output should be 1.0125
// console.log(seerToMon(5045)); //output should be 126.125
// console.log(seerToMon('me')); // output should be invalid message

// console.log(totalSales(10, 25, 28)); // output should be 20000
// console.log(totalSales(10, 25, -28)); // output should be invalid message.
// console.log(totalSales(0, 0, 0)); // output should be 0.
// console.log(totalSales(true, 25, 28)); // output should be invalid message.
// console.log(totalSales(10, 'fifty', 28)); // output should be invalid message.


// console.log(deliveryCost(10)); //output should be 1000
// console.log(deliveryCost(110)); //output should be 10800
// console.log(deliveryCost(10)); //output should be 1000
// console.log(deliveryCost("free")); //output should be a invalid message.
// console.log(deliveryCost(-100)); //output should be a invalid message.